 ...
 * @return none
 */
void configure_data_width (unsigned int inp_width);
 ...
 * valid values: 0 (Even) or 1 (Odd) / 0 (parity disable) or 1 (parity disable)
 *
 * @return none
 */
void configure_parity (unsigned int parity_select, unsigned int parity_enable);
 ...
 * @return none
 */
void transmit_data (char transmit);
